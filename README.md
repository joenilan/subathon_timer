...
- `apps/shared-session-service/`: Bun shared-session service scaffold for create/join, presence, server-owned shared timer snapshots, shared Twitch event ingestion, and tip-only provider ingestion
